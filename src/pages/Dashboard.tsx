  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow pt-20 pb-8">
        <section className="bg-gradient-to-r from-navy-700 to-cobalt-600 py-8">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex gap-3">
                <Button className="bg-white text-navy-700 hover:bg-white/90">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="mb-6 bg-white rounded-xl shadow-sm px-4 sm:px-6 py-2 border border-gray-200 flex items-center overflow-x-auto">
              ...
              >
                ...
                Notifications
                <span className="bg-cobalt-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">3</span>
              </button>
              <button
                className={`px-4 py-3 whitespace-nowrap text-sm font-medium flex items-center gap-2 rounded-lg transition-colors ${
                  activeTab === 'resources'
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-6">
              <Card className="bg-white border-none shadow-sm hover:shadow transition-shadow">
                <CardContent className="p-4 flex flex-col items-center text-center">
                  <div className="h-10 w-10 rounded-full bg-cobalt-100 text-cobalt-700 flex items-center justify-center mb-2">
              ...
              <Card className="bg-white border-none shadow-sm hover:shadow transition-shadow">
                <CardContent className="p-4 flex flex-col items-center text-center">
                  <div className="h-10 w-10 rounded-full bg-navy-100 text-navy-700 flex items-center justify-center mb-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-1">
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6">
                    <h3 className="text-lg font-medium mb-4 text-navy-900">Your Connections</h3>
                    <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
                      {Array(5).fill(0).map((_, i) => (
                        <div key={i} className="flex items-center p-3 rounded-lg hover:bg-cobalt-50 cursor-pointer">
                          <img 
                ...
                <div className="lg:col-span-2">
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6">
                    <h3 className="text-lg font-medium mb-4 text-navy-900">Connection Requests</h3>
                      ...
                      {Array(3).fill(0).map((_, i) => (
                        <div key={i} className="p-4 bg-gray-50 rounded-lg flex items-center gap-4">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button className="bg-cobalt-600 hover:bg-cobalt-700 h-8">
                              Accept
                            </Button>
                          </div>
                        </div>
                  ...
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    <h3 className="text-lg font-medium mb-4 text-navy-900">Upcoming Sessions</h3>
                    <div className="space-y-4">
                      {Array(3).fill(0).map((_, i) => (
                        <div key={i} className="p-4 bg-gray-50 rounded-lg flex items-center gap-4">
                          <img 
            ...
            {activeTab === 'history' && (
              <div className="grid grid-cols-1 gap-6">
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                  <h3 className="text-lg font-medium mb-4 text-navy-900">Recent Activity</h3>
                  <div className="space-y-4">
                    {Array(5).fill(0).map((_, i) => (
                      <div key={i} className="border-l-2 border-cobalt-500 pl-4 py-2">
            ...
            {activeTab === 'notifications' && (
              <div className="grid grid-cols-1 gap-6">
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div className="bg-cobalt-50 p-4 rounded-lg border-l-4 border-cobalt-500">
                      <div className="flex items-center">
                        <Bell className="h-5 w-5 text-cobalt-600 mr-2" />
                      ...
                      <div className="mt-2 flex gap-2">
                        ...
                        <Button size="sm" className="bg-cobalt-600 hover:bg-cobalt-700 h-8">Accept</Button>
                      </div>
                    </div>
                    
                    <div className="bg-cobalt-50 p-4 rounded-lg border-l-4 border-cobalt-500">
                      <div className="flex items-center">
                        <MessageSquare className="h-5 w-5 text-cobalt-600 mr-2" />
                    ...
                    <div className="bg-cobalt-50 p-4 rounded-lg border-l-4 border-cobalt-500">
                      <div className="flex items-center">
                        <Calendar className="h-5 w-5 text-cobalt-600 mr-2" />
                      ...
                      <div className="mt-2 flex gap-2">
                        ...
                        <Button size="sm" className="bg-cobalt-600 hover:bg-cobalt-700 h-8">Confirm</Button>
                      </div>
                    </div>
            ...
            {activeTab === 'resources' && (
              <div className="grid grid-cols-1 gap-6">
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                  <h3 className="text-lg font-medium mb-4 text-navy-900">Learning Resources</h3>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 text-center">
                    <Link to="/knowledge-hub" className="text-sm text-cobalt-600 hover:text-cobalt-700 font-medium">
