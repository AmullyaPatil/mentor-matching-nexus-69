  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card className="bg-white shadow-sm border-navy-200 overflow-hidden">
          <CardHeader className="p-4 bg-navy-50 border-b border-navy-100">
            <CardTitle className="text-base font-medium">Upcoming Sessions</CardTitle>
          </CardHeader>
          <CardContent className="p-4">
            <div className="space-y-3">
              {MOCK_USERS.slice(0, 3).map((mentee, index) => (
                <div key={mentee.id} className="p-3 bg-gray-50 rounded-lg flex items-center gap-3">
                  <img
                    src={mentee.avatar}
                    alt={mentee.name}
                  ...
                  <div className="flex gap-1">
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="h-7 w-7 p-0 border-navy-200 text-navy-700 hover:bg-navy-50"
                    ...
                    <Button 
                      size="sm" 
                      className="h-7 bg-cobalt-600 hover:bg-cobalt-700"
            ...
            <Link to="/calendar" className="text-xs mt-3 block text-cobalt-600 hover:text-cobalt-700 font-medium">
              View full calendar →
            </Link>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white shadow-sm border-navy-200 overflow-hidden">
          <CardHeader className="p-4 bg-navy-50 border-b border-navy-100">
            <CardTitle className="text-base font-medium">Connection Requests</CardTitle>
          </CardHeader>
          <CardContent className="p-4">
            <div className="space-y-3">
                ...
                <div key={mentee.id} className="p-3 bg-gray-50 rounded-lg flex items-center gap-3">
                  ...
                  <div className="flex gap-1">
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="h-7 border-navy-200 text-xs" 
                    ...
                    <Button 
                      variant="default" 
                      size="sm" 
                      className="h-7 bg-cobalt-600 hover:bg-cobalt-700 text-xs" 
      ...
      <Card className="bg-white shadow-sm border-navy-200 overflow-hidden">
        <CardHeader className="p-4 bg-navy-50 border-b border-navy-100">
          <CardTitle className="text-base font-medium">Active Mentee Connections</CardTitle>
        </CardHeader>
        <CardContent className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {MOCK_USERS.slice(0, 6).map((mentee) => (
              <div key={mentee.id} className="p-3 bg-gray-50 rounded-lg flex flex-col">
