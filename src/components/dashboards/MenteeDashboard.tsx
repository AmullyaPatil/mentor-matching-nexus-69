...
export default function MenteeDashboard({ user }: MenteeDashboardProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white p-6 rounded-xl border border-navy-200 shadow-sm">
          <h3 className="text-lg font-medium mb-4">My Skills Analysis</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              ...
              <div key={mentor.id} className="p-4 bg-gray-50 rounded-lg flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Button
                    variant="outline" 
                    size="sm" 
                    className="h-8 border-navy-200 text-navy-700 hover:bg-navy-50 flex items-center justify-center"
                  ...
                  <Button
                    size="sm" 
                    className="h-8 bg-cobalt-600 hover:bg-cobalt-700 flex items-center justify-center"
